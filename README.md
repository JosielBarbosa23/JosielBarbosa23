👋 Olá! Eu sou Josiel, um entusiasta da tecnologia que está migrando da área administrativa para o emocionante mundo da análise de dados e desenvolvimento. Já sou formado em administração desde 2021 e tenho experiência de 5 anos dentro da área administrativa onde puder aprender a importância dos dados para a tomada de decisão mais assertiva. Atualmente, estou mergulhando no universo da programação com Python 🐍, explorando bancos de dados com SQL 📊 e criando visualizações incríveis com o Power BI 📈.
